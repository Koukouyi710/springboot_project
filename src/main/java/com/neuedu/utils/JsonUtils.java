...
public class JsonUtils {
    ...
    static {
        ...
        //忽略在json中存在，但是在java中不存在的属性，防止出错
     ...
     *将json数组转换为Map集合
     */
    public static <T> T str2Obj(String str, Class<?> collectionClass,Class<?>...elements){
   ...
   /* public static void main(String[] args) {
        ...
        userInfo.setId(1);
        userInfo.setUsername("31wsawd单丝");
        userInfo.setEmail("1312@qq.com");
        userInfo.setCreateTime(new Date());
        String json = obj2String(userInfo);
        UserInfo userInfo1 = new UserInfo();
        userInfo1.setId(2);
        userInfo1.setUsername("31wsawd单丝");
        userInfo1.setEmail("1312@qq.com");
        userInfo1.setCreateTime(new Date());
        String json1 = obj2String(userInfo1);
        List<UserInfo>userInfoList = Lists.newArrayList();
        userInfoList.add(userInfo);
        userInfoList.add(userInfo1);

        String s = obj2StringPretty(userInfoList);
        List<UserInfo>userInfoList1 = str2Obj(s, new TypeReference<List<UserInfo>>() {
        });

        List<UserInfo>userInfoList2 = str2Obj(s,List.class,UserInfo.class);
